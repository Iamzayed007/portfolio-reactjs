...
const Contact = () => {
  function sendEmail(e) {
    ...
    return (
        <div id="contact" className="relative    pt-40 ">
            <h1 className="text-6xl text-white uppercase font-bold text-center py-4">Contact</h1>
    ...
    {/* style="backdrop-filter: blur(20px);" */}
      <div class="max-w-md mx-auto">
        ...
        <div class="divide-y divide-gray-200">
          <div class="py-8 text-base leading-6 space-y-4 text-buttonColor font-bold sm:text-lg sm:leading-7">
            ...
            <input name="name" type="text" placeholder="Name"
                  className="w-full h-10 border-gray-900 bg-textColor rounded-lg"
            ...
            <textarea  name="message" type="text" placeholder="Message"
                  className="w-full h-36 border-gray-900 bg-textColor rounded-lg" 

                  />  
                  
                  <button type="submit" class="mt-8 mb-4 py-1 px-6 rounded-full bg-buttonColor text-white tracking-widest  transition duration-200">Submit</button>
